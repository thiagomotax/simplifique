             ...
             <form class="form-horizontal" method="post" id="disciplinas-form">
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {?>
                                <?php  echo ' <button type="button" class="btn btn-alt-primary dropdown-item" data-toggle="tooltip"  id="rowInsereDisciplina_' . $i . '" data-id="'.$row['idDisciplina'].'" onclick="InsereDisciplina3(' . ($i) . ')">'.$row['nomeDisciplina'].'
