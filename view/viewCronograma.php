...
<div class="my-50 text-center">
        <h2 class="font-w700 text-black mb-10">
            <i class="fa fa-eye text-muted mr-5 text-primary"></i> Cronograma
        </h2>
        <br>
    </div> 
            ...
            <div class="modal-content">
             ...
             <form class="form-horizontal" method="post" id="disciplinas-form">
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        $stmt->execute();
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {?>
                                <?php  echo '<button type="button" class="btn btn-alt-primary dropdown-item" data-toggle="tooltip"  id="rowInsereDisciplina_' . $i . '" data-id="'.$row['idDisciplina'].'" data-nome="'.$row['nomeDisciplina'].'" data-nomeProfessor="'.$row['nomeUsuario'].'" data-contato="'.$row['emailUsuario'].'" onclick="InsereDisciplina2(' . ($i) . ')">'.$row['nomeDisciplina'].'
