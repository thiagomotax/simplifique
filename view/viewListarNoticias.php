...
#nomeP {
  ...
  text-overflow: ellipsis;
    ...
    <!-- Normal Modal -->
    <form class="form-horizontal" id="verNoticia-form" method="POST">
    <input type="hidden" name="acao" value="editar">
    <div class="modal" id="verNoticia" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered " role="document">
            ...
            <input type="hidden" name="id" id="id">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-alt-success" id="btnEditarNoticia" data-dismiss="modal">
