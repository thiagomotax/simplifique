    ...
    <div class="content">
        <div class="my-50 text-center">
            <h2 class="font-w700 text-black mb-10">
                <i class="fa fa-plus text-muted mr-5 text-primary"></i> Adicionar professor
            </h2>
        ...
        <div class="block block-rounded block-fx-shadow">
            <div class="block-content">
                <form class="js-validation-professor" id="form-cadastrar-professor" method="POST">
                    <input type="hidden" name="acao" value="adicionar">

                    <h2 class="content-heading text-black">Dados pessoais do professor</h2>
            ...
            <div class="form-group row">
                <div class="mx-auto">
                    <div class="form-group">
                        <button type="submit" id="button-cadastrar-professor" class="btn btn-alt-primary">
