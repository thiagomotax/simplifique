...
$query->execute();
    ...
    while ($rowAnexo = $query->fetch(PDO::FETCH_ASSOC)) {
        ...
        //$extensao=strtolower(substr($rowAnexo['materialAnexo'],  -4)); //pega a extenção do arquivo
        $local="../controller/anexos/".$rowAnexo['materialAnexo'];  //gera um novo nome com a extenção
