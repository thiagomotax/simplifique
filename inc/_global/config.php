...
$cb->author                     = 'Thiago Mota';
$cb->robots                     = 'noindex, nofollow';
$cb->title                      = 'Simplifique - Gerência Acadêmica Descomplicada';
$cb->description                = 'Simplifique - Gerência Acadêmica Descomplicada desenvolvido por Thiago Mota';
