...
<div class="row no-gutters hero-static">
        ...
        <div class="content content-full d-flex align-items-center text-center">
            <div class="w-100 px-20 py-100">
                ...
                <h1 class="font-w600 display-3 invisible mb-10" data-toggle="appear">
                    codebase <small class="font-w300 text-primary"><?php echo $cb->version; ?></small>
                </h1>
                ...
                <div class="invisible" data-toggle="appear" data-timeout="300">
                    ...
                    <a class="btn btn-hero btn-noborder btn-primary min-width-175 mb-10 mx-5" href="be_pages_dashboard.php">
    ...
    <div class="col-xl-4 d-flex flex-column flex-wrap overflow-hidden text-center text-xl-left bg-white hero-static">
        <div class="content content-full d-flex align-items-center flex-grow-1 bg-warning-light hero-promo">
            <div class="w-100 p-20 invisible" data-toggle="appear" data-class="animated fadeInRight">
        ...
        <div class="content content-full d-flex align-items-center flex-grow-1 bg-danger-light hero-promo">
            <div class="w-100 p-20 invisible" data-toggle="appear" data-class="animated fadeInRight" data-timeout="150">
                <div class="font-size-h3 font-w600 text-black mb-5">
                    Laravel Starter Kit
                </div>
                <p class="font-size-h4 font-w400 text-black-50 mb-0">
        ...
        <div class="content content-full d-flex align-items-center flex-grow-1 bg-gray hero-promo">
            <div class="w-100 p-20 invisible" data-toggle="appear" data-class="animated fadeInRight" data-timeout="300">
                <div class="font-size-h3 font-w600 text-black mb-5">
    ...
    <div class="content content-full">
        <div class="pt-100 pb-50">
            ...
            <div class="text-center">
                <a class="btn btn-hero btn-noborder btn-primary min-width-175" href="be_pages_dashboard2.php">
...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="pt-100 pb-50">
            ...
            <div class="text-center">
                <a class="btn btn-hero btn-noborder btn-primary min-width-175" href="be_pages_generic_todo.php">
