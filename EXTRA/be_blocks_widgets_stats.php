...
<div class="content">
    ...
    <!-- Chart.js Charts functionality is initialized in js/pages/be_blocks_widgets_stats.min.js which was auto compiled from _es6/pages/be_blocks_widgets_stats.js -->
...
<!-- Page JS Code -->
<?php $cb->get_js('js/pages/be_blocks_widgets_stats.min.js'); ?>
